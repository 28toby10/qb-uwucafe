...
Config.Zones = {
    ...
    [7] = { coords = vector3(-585.25, -1055.29, 22.34), radius = 0.78, icon = "fa-solid fa-warehouse", event = "qb-uwucafe:client:stash4", label = "Stash", job = "uwu" }, 
    ...
    [24] = { coords = vector3(-706.06, -913.97, 19.22), radius = 0.8, icon = "fa-solid fa-basket-shopping", event = "qb-uwucafe:client:openShop", label = "UwU Shop", job = "uwu" },
